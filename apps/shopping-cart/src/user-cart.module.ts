...
@Module({
	...
	providers: [UserCartService, { provide: Repositories.USER_CART, useClass: UserCartRepository }],
	controllers: [UserCartController],
	exports: [UserCartService, { provide: Repositories.USER_CART, useClass: UserCartRepository }]
})
