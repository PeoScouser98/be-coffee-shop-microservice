...
export class ProductController {
	...
	public async createProduct(@Body() payload: ProductDTO, @Res() res: Response) {
		...
		const responseBody = new ResponseBody(
			data,
			HttpStatus.CREATED,
			this.localizationService.t('success_messages.product.created')
		)
		return res.json(responseBody)
	}
	...
	public async updateProduct(
		...
		const responseBody = new ResponseBody(
			result,
			HttpStatus.OK,
			this.localizationService.t('success_messages.product.updated')
		)
		return res.json(responseBody)
	}
	...
	public async publishProductToStore(@Param('id') id: string, @Res() res: Response) {
		...
		const responseBody = new ResponseBody(
			data,
			HttpStatus.CREATED,
			this.localizationService.t('success_message.product.published')
		)
		return res.json(responseBody)
	}
